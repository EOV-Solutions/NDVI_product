...
async def full_process_inference(background_task):
    time = now_utc()
    ...
    background_task.add_task(product_ndvi_full_process_background, task_id, time, data)
...
def product_ndvi_full_process_background(task_id: str, time: datetime, data: MlResult):
    try: 
